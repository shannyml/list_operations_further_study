...
def custom_insert(input_list, index, value):
    ...
    """
    section_list = input_list[index:]
    input_list[:index]
    input_list[len(input_list):-1] = [value]
    input_list[len(input_list):-1] = section_list
    return section_list

    # new_list1 = input_list[:index]
    # new_list2 = input_list[index:]
    # new_list1[len(new_list1):-1] = value
    # new_list1[len(new_list1):-1] = new_list2
    # return new_list2
    pass
